      ...
      <div className="flex w-full max-w-7xl flex-col-reverse items-center justify-between py-4 md:flex-row">
        <div className="flex flex-[0.5] flex-col items-center gap-3 md:items-start">
          <h1
            ...
            className="p-5 text-center font-newake text-6xl leading-[4.25rem] md:text-start"
          >
            <RoughNotation
              type="underline"
          ...
          <h3 className="p-5 text-center font-poppins text-xl leading-9 text-slate-500 md:text-start">
            At Markesia Identity, we're your compass in the digital world. Our
